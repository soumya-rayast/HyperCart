                            ...
                            <div className="flex flex-wrap mb-24 -mx-4">
                                ...
                                <div className="w-full px-4 md:w-1/2">
                                    <div className="lg:pl-20">
                                        <div className="mb-6">
                                            <h2 className="max-w-xl mb-6 text-2xl font-semibold leading-loose tracking-wide text-gray-800 md:text-3xl dark:text-gray-300">
                                                {product?.title}
                                            </h2>
                                        ...
                                        <div className="flex flex-wrap items-center mb-6">
                                            <button
                                                className="w-full px-4 py-3 text-center text-white bg-pink-600 border border-pink-600 hover:bg-pink-700 rounded-xl transition duration-300"
                                            >
                                                Add to Cart
                                            </button>
                                        </div>
